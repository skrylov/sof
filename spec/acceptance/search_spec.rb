...
feature 'Search' do
  given!(:question_match_body) { create(:question, title: 'Question 1', body: 'testtest')}
  given!(:question_match_title) {create(:question, title: 'Question testtest', body: 'body 123')}
